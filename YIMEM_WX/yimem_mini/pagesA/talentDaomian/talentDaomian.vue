<template>
	...
	<navBarTop title=" " imgNavBg="../../static/images/tuijian.png" backgroundColor="rgba(255, 255, 255, 0)" color="#FFFFFF"></navBarTop>
		<image class="yjpbh" src="../../static/images/daomiao.png" mode=""></image>
		<view class="conetent">
			...
			<view class="newContent">
				<view class="topTotall">
					<view class="totalls">
						...
						<view class="bigFont">
							{{recommendObj.peoplenum | captionToZero}}
						</view>
					</view>
					<view class="litShu">
				...
				<view class="pList">
					...
					<view class="pListBox">
						<view class="pOneBox" v-if="recommendList[0]">
							...
							<view class="leftHead">
								<image class="topOneHead" src="../../static/images/topOne.png" mode=""></image>
							...
							<view class="rightNum">
								{{recommendList[0].peoplenum | captionToZero}}
								<text class="topLitSize">人</text>
							</view>
						</view>
						<view class="pOneBox" v-if="recommendList[1]">
							...
							<view class="leftHead">
								<image class="topOneHead" src="../../static/images/topTwo.png" mode=""></image>
								<view class="headImgBox">
							...
							<view class="rightNum">
								{{recommendList[1].peoplenum | captionToZero}}
								<text class="topLitSize">人</text>
							</view>
						</view>
						<view class="pOneBox" v-if="recommendList[2]">
							...
							<view class="leftHead">
								<image class="topOneHead" src="../../static/images/topTh.png" mode=""></image>
								<view class="headImgBox">
							...
							<view class="rightNum">
								{{recommendList[2].peoplenum | captionToZero}}
								<text class="topLitSize">人</text>
							</view>
						</view>
...
<script>
	...
	import {vpnInterviewRankingListsvc
	} from "../../api/index.js"
	export default {
		data() {
			return {
		...
		methods: {
			...
			initRecommend: function() {
				let that = this;
				let data = {
					vpnInterviewRankingList: {
						userId: that.userId,
						ranking: that.timeIndex
					}
				}
				vpnInterviewRankingListsvc(data).then(res => {
					console.log(res)
					if (res.code == 1) {
